...
package org.yqj.source.zk.curator.example.discovery;
...
public class DiscoveryExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            client = CuratorFrameworkFactory.newClient("localhost:2181,localhost:2182,localhost:2183", new ExponentialBackoffRetry(1000, 3));
            client.start();
