...
//        myClassLoaderParent();
    ...
    private static void myClassLoader(){
        try {
            ClassLoader classLoader1 = new MyClassLoader("classDir");
            Class classDate1 = classLoader1.loadClass("org.yqj.source.lang.base.classloader.MyDate");

            ClassLoader classLoader2 = new org.yqj.source.lang.base.classloader.MyClassLoader("target/classes/org/yqj/source/basic/base/classloader");
