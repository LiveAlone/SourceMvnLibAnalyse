...
//        keysScan();
    ...
    public static void pfCountRate() {
    ...
    public static void keysScan() throws Exception {
        RedisClient redisClient = RedisClient.create("redis://localhost/0");
        StatefulRedisConnection<String, String> stringStringStatefulRedisConnection = redisClient.connect();
        RedisCommands<String, String> redisCommands = stringStringStatefulRedisConnection.sync();
...
//            log.info("redis key gain from key:{}, value:{} ", key, redisCommands.get(key));
    ...
    public static void getRedisKey() throws Exception {
        RedisClient redisClient = RedisClient.create("redis://localhost/0");
        StatefulRedisConnection<String, String> stringStringStatefulRedisConnection = redisClient.connect();
        RedisCommands<String, String> redisCommands = stringStringStatefulRedisConnection.sync();
    ...
    public static void getKeyReactiveTask() throws Exception {
        RedisClient redisClient = RedisClient.create("redis://localhost/0");
...
//        Thread.sleep(2000);
    ...
    public static void getRunTask() throws Exception {
        RedisClient redisClient = RedisClient.create("redis://localhost/0");
        StatefulRedisConnection<String, String> connection = redisClient.connect();
        log.info("**** start");
        // event loop 线程名称
    ...
    public static void testPingPongRedis() {
        RedisClient redisClient = RedisClient.create("redis://localhost/0");
        StatefulRedisConnection<String, String> connection = redisClient.connect();
